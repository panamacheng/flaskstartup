...
app.config['MYSQL_PASSWORD'] = 'Rango941001top!@#'
...
def register():
  ...
  if request.method == 'POST' and form.validate():
    ...
    # excute query
    insert_query = 'INSERT INTO users(name, email, username, password, register_date) VALUES(%s, %s, %s, %s, %s)'
    cur.execute(insert_query, (name, email, username, password, register_date))
